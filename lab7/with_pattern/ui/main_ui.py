...
class UiDialog(object):
    def setupUi(self, Dialog):
        ...
        self.ProfileManager.setObjectName("ProfileManager")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(
            QCoreApplication.translate("Dialog", "Менеджер задач", None)
        )
        self.label_3.setText(QCoreApplication.translate("Dialog", "Задачи", None))
        self.create_task_button.setText(
            QCoreApplication.translate("Dialog", "Создать новую задачу", None)
        )
        self.edit_task_button.setText(
            QCoreApplication.translate("Dialog", "Редактировать", None)
        )
        self.delete_task_button.setText(
            QCoreApplication.translate("Dialog", "Удалить", None)
        )
        self.save_task_button.setText(
            QCoreApplication.translate("Dialog", "Сохранить", None)
        )
        self.cancel_edit_button.setText(
            QCoreApplication.translate("Dialog", "Отмена", None)
        )
        self.task_title_label.setText(
            QCoreApplication.translate("Dialog", "Название задачи:", None)
        )
        self.task_date_label.setText(
            QCoreApplication.translate("Dialog", "Дата и время:", None)
        )
        self.task_description_label.setText(
            QCoreApplication.translate("Dialog", "Описание задачи:", None)
        )
        self.view_task_date_label.setText(
            QCoreApplication.translate("Dialog", "Дата и время:", None)
        )
        self.view_task_description_label.setText(
            QCoreApplication.translate("Dialog", "Описание задачи:", None)
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.TaskManager),
            QCoreApplication.translate("Dialog", "Управление задачами", None),
        )
        self.label.setText(
            QCoreApplication.translate("Dialog", "Адрес электронной почты", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("Dialog", "Аккаунт телеграм", None)
        )
        self.checkBox.setText(
            QCoreApplication.translate(
                "Dialog", "Присылать уведомления на почту?", None
            )
        )
        self.checkBox_2.setText(
            QCoreApplication.translate(
                "Dialog", "Присылать увеомления в телеграм?", None
            )
        )
        self.textEdit.setPlaceholderText(
            QCoreApplication.translate("Dialog", "id аккаунта телеграм", None)
        )
        self.textEdit_2.setPlaceholderText(
            QCoreApplication.translate("Dialog", "example@mail.com", None)
        )
        self.pushButton.setText(QCoreApplication.translate("Dialog", "Сохранить", None))
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.ProfileManager),
            QCoreApplication.translate("Dialog", "Управление профилем", None),
        )
